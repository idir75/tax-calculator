...
Par ailleurs, l'interface `TaxCalculationStrategy` peut être implémentée par d'autres classes sans hériter la classe abstraite `DefaultTaxCalculationStrategy` et définir des stratégies de calcul différentes.
