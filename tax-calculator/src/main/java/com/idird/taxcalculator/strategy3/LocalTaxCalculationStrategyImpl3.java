...
public class LocalTaxCalculationStrategyImpl3 implements TaxCalculationStrategy3 {

    private final BigDecimal localTaxMt;
    private final DecimalRounder decimalRounder;

    public LocalTaxCalculationStrategyImpl3(BigDecimal p_localTaxMt, DecimalRounder p_decimalRounder) {
